...
#   2 atom(s)
mol.atom = '''
N1              0.00000000        0.00000000        0.000000
N2              0.00000000        0.00000000       0.90000000
'''
...
Sdiag = S.diagonal()
alpha_coeff = fch2py('uhf-0.90.fchk', nbf, nif, Sdiag, 'a')
beta_coeff = fch2py('uhf-0.90.fchk', nbf, nif, Sdiag, 'b')
